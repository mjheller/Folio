...
namespace Folio.Migrations
{
    ...
    [Migration("20160113194548_Initial")]
    partial class Initial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Folio.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Folio.Models.Portfolio", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Folio.Models.Stock", b =>
                {
                    ...
                    b.Property<string>("PriceHistory1YearJSON");
            ...
            modelBuilder.Entity("Folio.Models.Portfolio", b =>
                {
                    b.HasOne("Folio.Models.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Folio.Models.PortfolioAsset", b =>
                {
                    b.HasOne("Folio.Models.Portfolio")
                        .WithMany()
